...
namespace Cowboy.WebSockets
{
    internal static class StringBuilderExtensions
    {
        ...
        public static void AppendFormatWithCrCf(StringBuilder builder, string format, params object[] args)
        {
            builder.AppendFormat(format, args);
            builder.Append(_crcf);
        }

        public static void AppendWithCrCf(StringBuilder builder, string text)
        {
            builder.Append(text);
            builder.Append(_crcf);
        }
