...
namespace Cowboy.WebSockets
{
    internal sealed class WebSocketClientHandshaker
    {
        ...
        internal static byte[] CreateOpenningHandshakeRequest(WebSocketClient client, out string secWebSocketKey)
        {
            ...
            StringBuilderExtensions.AppendFormatWithCrCf(sb, Consts.HeaderLineFormat, HttpKnownHeaderNames.Host, client.Uri.Host);

            // The request MUST contain an |Upgrade| header field whose value
            // MUST include the "websocket" keyword.
            StringBuilderExtensions.AppendFormatWithCrCf(sb, Consts.HeaderLineFormat, HttpKnownHeaderNames.Upgrade, Consts.WebSocketUpgradeToken);

            // The request MUST contain a |Connection| header field whose value
            // MUST include the "Upgrade" token.
            StringBuilderExtensions.AppendFormatWithCrCf(sb, Consts.HeaderLineFormat, HttpKnownHeaderNames.Connection, Consts.WebSocketConnectionToken);
            ...
            StringBuilderExtensions.AppendFormatWithCrCf(sb, Consts.HeaderLineFormat, HttpKnownHeaderNames.SecWebSocketKey, secWebSocketKey);

            // The request MUST include a header field with the name
            // |Sec-WebSocket-Version|.  The value of this header field MUST be 13.
            StringBuilderExtensions.AppendFormatWithCrCf(sb, Consts.HeaderLineFormat, HttpKnownHeaderNames.SecWebSocketVersion, Consts.WebSocketVersion);
